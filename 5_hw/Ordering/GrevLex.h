...
#ifndef INC_5_HW_GREVLEX_H
#define INC_5_HW_GREVLEX_H

#include "interfaces.h"

template <typename T>
class GrevLexOrder final : public MonomialOrder<T>
{
public:
    ~GrevLexOrder() override = default;
